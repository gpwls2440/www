...
export default {
  ...
  mounted() {
    ...
    document.getElementById('b1m').addEventListener('click', function () {
      const max = dateAxis.groupMax.day1
    ...
    document.getElementById('bmax').addEventListener('click', function () {
      const min = dateAxis.groupMin.day1
    ...
    function updateZoom() {
      ...
      zoomTimeout = setTimeout(function () {
        ...
        const startDate = chart.dateFormatter.parse(start, inputFieldFormat)
        const endDate = chart.dateFormatter.parse(end, inputFieldFormat)
